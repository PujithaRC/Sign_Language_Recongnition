...
#draws the landmarks and connections on the image if hand landmarks are detected
...
#returns the flattened x,y,z coordinates of the detected hand landmarks if there are any detected.
